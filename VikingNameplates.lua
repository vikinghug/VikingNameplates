...
-- Removed Viking from the strings where it didn't belong, Crowdedlight
...
local karDisposition = 
{
	...
	tHealthBar =
	{
		[Unit.CodeEnumDisposition.Hostile] 	= "BasicSprites:WhiteFill",
		[Unit.CodeEnumDisposition.Neutral] 	= "BasicSprites:WhiteFill",
		[Unit.CodeEnumDisposition.Friendly] = "BasicSprites:WhiteFill",
	},
